...
#https://bookdown.org/rb76/444/data-wrangling.html
```
...
df <- read.csv("C:/Users/nbngo/OneDrive/Work/[C]_ResearchMethods/quant_rm/Data/Dataset_environmental_sustainability.csv", sep = ",", header = T)
...
df <- read_excel("C:/Users/nbngo/OneDrive/Work/[C]_ResearchMethods/quant_rm/Data/Dataset_environmental_sustainability.xlsx")
...
save(df, file = "C:/Users/nbngo/OneDrive/Work/[C]_ResearchMethods/quant_rm/Data/environment_survey.Rdata")
